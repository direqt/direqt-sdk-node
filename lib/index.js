...
module.exports.DEMO_APIKEY_SECRET = 'demo-apikey-secret';
 ...
 *  (3) DIREQT_APIKEY_ID and DIREQT_APIKEY_SECRET environment variables.
 *
 ...
 * @param {String=} options.apiKeySecret The api key secret to use.
...
function Direqt(options) {
    ...
    apiKeySecret = apiKeySecret || process.env['DIREQT_APIKEY_SECRET'] || DEFAULT_APIKEY_SECRET;
